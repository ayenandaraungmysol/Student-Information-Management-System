                    ...
                    <div class="card-body">
                        ...
                        <form id="form" action="{{ route('teacher.student.editSave', $student->id) }}" method="POST"><!--Need To Modify-->{{-- action="{{ route('student.store') }}"--}}
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="text" class="form-control " value="{{$student->name}}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="email" type="email" class="form-control " value="{{$student->email}}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="age" type="age" class="form-control" name="age" value="{{$student->age}}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="fatherName" type="fatherName" class="form-control" name="fatherName" value="{{$student->father_name}}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="address" type="address" class="form-control" name="address" value="{{$student->address}}" >
